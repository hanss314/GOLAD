...
public class SelectPlayers extends Button
{
    ...
    public SelectPlayers(MyWorld w, int diff){
        super(w,new GreenfootImage("Buttons/player.png"));
    ...
    public void clickAction(){
        ...
        if(difficulty==0){
            this.setImage("Buttons/botEasy.png");
        }else if(difficulty == 2){
            this.setImage("Buttons/botMed.png");
        }else if(difficulty == 4){
            this.setImage("Buttons/botHard.png");
        }else if(difficulty == 6){
            this.setImage("Buttons/player.png");
        }
    }
}
